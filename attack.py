...
parser.add_argument('--model',  nargs='+', choices=model_defs.keys(), default='resnet18',
...
def main():
  ...
  models=[model_defs[m](pretrained=True) for m in args.model]
  net=models[0].cuda()
  cudnn.benchmark=True
  print ("==> Starting attck...")
  results = attack_all(net, loader=testloader, pixels=args.pixels, targeted=args.targeted, maxiter=args.maxiter, popsize=args.popsize, verbose=args.verbose)
